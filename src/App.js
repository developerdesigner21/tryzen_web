...
function App() {
  ...
  const imagePaths = [
    ...
    require('./assets/rest-burger.webp'),
    require('./assets/rest-fast-food.webp'),
    require('./assets/rest-delight.webp'),
    require('./assets/rest-hotdos.webp'),
    require('./assets/rest-sandwitch.webp'),
    require('./assets/rest-variety.webp'),
