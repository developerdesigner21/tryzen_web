        ...
        <div id="features" class="rounded-xl">
            ...
            <div class="grid grid-cols-[repeat(auto-fill,minmax(260px,1fr))] gap-6 lg:gap-8">
                ...
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#EEECFF" }}>
                    ...
                    <h3 class="text-md md:text-xl font-semibold mb-2">Google Ranking & Social <br /> media marketing</h3>
                    <p class="text-gray-700 text-sm font-semibold mt-3 md:mt-6">We help Combining Google ranking with social
                        media marketing creates a powerful strategy to drive visitors into customers.</p>
                </div>
