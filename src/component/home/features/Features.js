        ...
        <div id="features" class="rounded-xl">
            ...
            <div class="grid grid-cols-[repeat(auto-fill,minmax(260px,1fr))] xl:grid-cols-4 gap-6 lg:gap-8">
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#E0F8F2" }}>
                    ...
                    <p class="text-gray-700 text-sm font-semibold">It offer interactive features such as easy
                ...
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#FFEECB" }}>
                    ...
                    <p class="text-gray-700 text-sm font-semibold">It help to Manage multiple stores with
                ...
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#F1F1F1" }}>
                    ...
                    <p class="text-gray-700 text-sm font-semibold">We ensures faster speed, optimised
                ...
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#D9F2F7" }}>
                    ...
                    <p class="text-gray-700 text-sm font-semibold">This Feature Enable quick deliveries using
                ...
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#EEECFF" }}>
                    ...
                    <p class="text-gray-700 text-sm font-semibold">We help Combining Google ranking with social
                ...
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#DAFFF6" }}>
                    ...
                    <p class="text-gray-700 text-sm font-semibold">Engage customers instantly through personalised messages and updates et more attention,
                ...
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#FDF3EA" }}>
                    ...
                    <p class="text-gray-700 text-sm font-semibold">Increase your sales by offering exclusive deals and coupons to attract new customers 
                ...
                <div class="p-4 md:p-6 rounded-lg text-center" style={{ backgroundColor: "#FFEFBA" }}>
                    ...
                    <p class="text-gray-700 text-sm font-semibold">POS helps smarter decision-making with real-time data and sales analysis, inventory management & insights.</p>
                </div>
            </div>
        </div>
    )
