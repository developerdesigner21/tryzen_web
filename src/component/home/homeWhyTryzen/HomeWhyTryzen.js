            ...
            <div className="section-home p-4 sm:p-6 md:p-4 lg:p-6 xl:p-8 gap-5 xl:gap-0">
                ...
                <div className="section-home-right justify-between">
                    ...
                    <div className='demo-grid grid grid-cols-2 items-center gap-2 sm:gap-5'>
                        <div className="flex flex-col items-center justify-center bg-white p-2 md:p-4 rounded-lg h-full small-padding" onClick={ ()=> window.open("https://codmarket.co.ke/", "_blank") }>
                            <div>
                                <h1 className='uber-home text-[#0F54FF] text-center mb-4 text-lg sm:text-xl'>ECOMMERCE</h1>
                                <img src={require('../../../assets/ecommerceHome.webp')} alt="QR Code Website" className='check-images-home object-cover' />
                            </div>
                            <div className='demo-buttons-home w-full'>
                                <div className="flex items-center rounded-full bg-[#0F54FF] gap-2 px-4 py-2 font-bold text-xs lg:text-sm small-button">
                                    <span className="uber-content-home xl:text-lg">DEMO WEBSITE</span>
                                    <img src={require('../../../assets/buttonArrow.png')} alt="Arrow" className='w-4 h-2 arrow-image-home' />
                                </div>
                            </div>
                        </div>
                        <div className="flex flex-col items-center justify-center bg-white p-2 md:p-4 rounded-lg h-full small-padding"  onClick={ ()=> window.open("https://restaurant.tryzensolution.com/", "_blank") }>
                            <div>
                                <h1 className='uber-home text-[#EA2C26] text-center text-lg sm:text-xl'>RESTAURANT</h1>
                                <img src={require('../../../assets/restaurentHome.webp')} alt="QR Code Website" className='check-images-home object-cover' />
                            </div>
                            <div className='demo-buttons-home w-full'>
