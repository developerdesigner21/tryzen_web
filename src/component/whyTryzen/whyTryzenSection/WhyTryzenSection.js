    ...
    return (
        <div className='flex items-center'>
            <div className="section-why p-4 sm:p-6 md:p-4 lg:p-6 xl:p-8 gap-5 xl:gap-0">
                <div className="section-why-left md:w-1/2">
                ...
                <div className="section-why-right justify-between w-1/2">
                    <div>
                    ...
                    <div className='demo-grid grid grid-cols-2 items-center gap-2 sm:gap-5'>
                        ...
                        <a href="https://restaurant.tryzensolution.com/" target='_blank'>
                            <div className='flex flex-col items-center justify-center bg-white p-2 md:p-4 rounded-lg h-full small-padding'>
                                <div>
                                    <h1 className='uber-why text-[#EA2C26] text-center text-lg mb-4 sm:text-xl'>RESTAURANT</h1>
